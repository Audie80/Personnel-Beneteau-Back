module.exports = (app) => {
    const employees = require('../controllers/employeesTest.controller.js');
    ...
    app.put('/api/employees/:ID_EMPLOYEE/update', employees.update);

    // Delete an Employee with ID_EMPLOYEE
    app.delete('/api/employees/:ID_EMPLOYEE/delete', employees.delete);
}