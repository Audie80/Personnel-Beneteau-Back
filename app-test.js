...
const employeesRoutes = require("./express/routes/employeesTest.routes");
...
bddsqlTest.BDDSQLTEST.connect(function(err) {
  if (err) throw err;
...
app.use(function(req, res, next) {
  res.header("Access-Control-Allow-Origin", "http://localhost") ||
    res.header(
      ...
      "http://app-68a07762-5ead-4cd7-b368-9f26ecac6c86.cleverapps.io"
    );
  res.header(
